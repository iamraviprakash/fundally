    ...
    <div class="container-fluid" id="main">
        <div class="row" >
        	...
        	<div class="col-md-9">
        		...
        		<c:if test="${displayProject.getProjectIncharge() == userEmailId}">
	        		
	        		<div style="display: table; margin: auto;font-weight: bold; font-size: 1.2em;">Add Faculty</div>
					<hr style="width:50%;">
	        		<form method="post" action="faculty/add">
		        		<input type="text" name="facultyEmailId" placeholder="Enter Faculty Email-Id" />
		        		<input type="submit" value="Add"/>
		        	</form>
		        
		        	<div style="display: table; margin: auto;font-weight: bold; font-size: 1.2em;">Add Account</div>
					<hr style="width:50%;">
	        		<form:form method="post" action="account/add" modelAttribute="newProjectAccountForm">
		        		Account Type: 
		        		<form:select path="accountTypeId">
		        			<c:forEach var="tempProjectAccountTypeList" items="${projectAccountTypeList}">
		        				<form:option value="${tempProjectAccountTypeList.getId()}">${tempProjectAccountTypeList.getName()}</form:option>
		        			</c:forEach>
		        		</form:select> 
		        		<form:input type="text" placeholder="Enter Balance" path="balance"/>
		        		<input type="submit" value="Add"/>
		        	</form:form>
						...
						<tr>
							...
							<td>
								<ul type="none">
									...
									<li><a href="account/${tempDisplayProjectAccountList.getAccountNo()}/request/new"> New Request </a></li>
								</ul>
	        				</td>
						</tr>
					</c:forEach>
