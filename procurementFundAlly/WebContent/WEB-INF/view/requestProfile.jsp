...
<body>
    ...
    <div id="sidepane" style="display: block;">
       ...
       <div class="list">
            <a href="/request/"><div id="active">Request</div></a>
        	...
        	<div class="col-md-9">
        		...
        		<c:if test="${source == 'project' }">
		        	...
		        	<table class="horizontalTable">
		        		<tr><td>Project Id</td><td>${project.getId()}</td></tr>
		        		<tr><td>Name</td><td>${project.getName()}</td></tr>
		        		<tr><td>Description</td><td>${project.getDescription()}</td></tr>
		        		<tr><td>Project In-charge</td><td>${project.getProjectIncharge().getEmailId()}</td></tr>
		        		<tr><td>Sanctioned Amount</td><td>${project.getSanctionedAmount()}</td></tr>
		        	</table>
	        	</c:if>
	        	...
	        	<table class="horizontalTable">
	        		...
	        		<tr><td>Account No</td><td>${account.getAccountNo()}</td></tr>
	        	...
	        	<table class="horizontalTable">
	        		...
	        		<tr><td>Upload</td><td>${uploadForm}</td></tr>
	   				<tr><td>Options</td><td>${approveUrl}</td></tr>
	        	</table>
