        ...
        <div class="row" >
        	...
        	<div class="col-md-9">
	        	...
	        	<table>
					...
					<c:forEach var="tempTransactionList" items="${displayTransactionList}">
						<tr>
							<td>${tempTransactionList.getTransactionId()}</td>
							<td>${tempTransactionList.getResourceName()}</td>
							<td>${tempTransactionList.getOpeningBalance()}</td>
							<td>${tempTransactionList.getClosingBalance()}</td>
							<td>${tempTransactionList.getType()}</td>
							<td>${tempTransactionList.getDate()}</td>
						</tr>
					</c:forEach>
				</table>
			</div>
